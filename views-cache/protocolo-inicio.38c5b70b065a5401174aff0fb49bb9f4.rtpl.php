        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#modalNovoDoc"><i class="fas fa-file-download"></i>&nbsp;&nbsp;INCLUIR NOVO DOCUMENTO</button>
              </div>
            </div>
          </div>
          <!-- /.col-md-6 -->
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0"><strong>DOCUMENTOS AGUARDANDO PROTOCOLO</strong></h5>
              </div>
              <div class="card-body">
                <table id="aguardandoProtocolo" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   <?php $counter1=-1;  if( isset($listarDocumentos) && ( is_array($listarDocumentos) || $listarDocumentos instanceof Traversable ) && sizeof($listarDocumentos) ) foreach( $listarDocumentos as $key1 => $value1 ){ $counter1++; ?>

                  <tr>
                    <td><?php echo $value1["ID"]; ?></td>
                    <td><?php echo $value1["Documento"]; ?>/<?php echo $value1["Ano"]; ?></td>
                    <td><?php echo $value1["Tipo"]; ?></td>
                    <td><?php echo $value1["Entrada"]; ?></td>
                    ...
                    <td style="width: 100px; text-align: center;">
                      ...
                      <a href="/impressoes/recibo/<?php echo $value1["ID"]; ?>/<?php echo $value1["IDEntrada"]; ?>" target="_blak"><button type="button" class="btn btn-outline-primary"><i class="fas fa-print"></i></button>
                    </td>
                  </tr>
                    <?php } ?>
