<?php if(!class_exists('Rain\Tpl')){exit;}?>  <!-- Main Footer -->
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
      Dinâmica MKT | Soluções
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">Dinâmica MKT</a>.</strong> Todos os direitos reservados.
  </footer>
</div>
<!-- ./wrapper -->
...
<script src="/res/admin/plugins/fullcalendar/main.js"></script>
...
<script>
$('#modalNovoCliente').on('show.bs.modal', function (event) {
  var button = $(event.relatedTarget) // Button that triggered the modal 
  // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
  var modal = $(this)
  modal.find('.modal-title').text('Incluir novo Cliente')
})
</script>
